        ...
        MethodChannel(flutterEngine!!.dartExecutor, CHANNEL).setMethodCallHandler { call, result ->
            ...
            if (call.method == "printPdf") {
                ...
                if (macAddress != null && path != null && uuidSpp != null) {
                    ...
                    val success =
                        PrinterHelper.printPdf(applicationContext, macAddress, path, uuidSpp)
...
//                                .setRepeat(1)  // Single buzz; avoid high values or 0 if it loops infinitely
//                                .setOnTime(200)  // 200ms on time for a short ring
//                                .setOffTime(0)
//                        )  // No pause needed for single buzz
//                )

                // Add DrawerBuilder for external buzzer
                docBuilder.addDrawer(
                    DrawerBuilder()
                        .actionOpen(
                            OpenParameter()
                                .setChannel(Channel.No1) // Use Drawer.Channel.No1
