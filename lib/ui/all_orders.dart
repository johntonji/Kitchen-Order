              ...
              children: [
                DropdownMenu(
                  ...
                  menuStyle: MenuStyle(
                    ...
                    backgroundColor: WidgetStateProperty.all(AppAssets.whiteColor),
                    shadowColor: WidgetStateProperty.all(AppAssets.textLightGrayColor.withOpacity(0.2)),
                    surfaceTintColor: WidgetStateProperty.all(AppAssets.whiteColor),
                    side: WidgetStateProperty.resolveWith((states) => const BorderSide(color: AppAssets.primaryColor))
                  ),
                  onSelected: (newValue) {
                    setState(() {
                  ...
                  dropdownMenuEntries: orderItems.map<DropdownMenuEntry<String>>(
                        ...
                        return DropdownMenuEntry<String>(
                          ...
                          label: item,
                          style: ButtonStyle(
                            textStyle: WidgetStateTextStyle.resolveWith((states) => TextStyle(fontSize: 12, fontFamily: AppAssets.nunitoBold, color: AppAssets.primaryColor),)
                          )
                        );
                      }).toList(),
                ),
                DropdownMenu(
                  ...
                  menuStyle: MenuStyle(
                      ...
                      shadowColor: WidgetStateProperty.all(AppAssets.textLightGrayColor.withOpacity(0.2)),
                      surfaceTintColor: WidgetStateProperty.all(AppAssets.whiteColor),
                      side: WidgetStateBorderSide.resolveWith((states) => const BorderSide(color: AppAssets.primaryColor))
                  ),
                  onSelected: (newValue) {
                    setState(() {
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    provider.acceptOrder(userModel.authToken!, order.orderData.orderUuid, order.orderData.deliveryDate, getTimeString(minutes),
                                                     false,
                                                      ...
                                                      debugPrint("could not accept order $e");
                                                    }
                                                  },
                                                  child: Container(
                                                    height: 40,
