...
class UtilityClass {
 ...
 static showLoadingDialog(BuildContext context) {
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(child: Text("Please Wait", style: TextStyle(fontSize: AppAssets.dimen_18, fontFamily: AppAssets.nunitoRegular, color: AppAssets.textDarkGrayColor), maxLines: 2, overflow: TextOverflow.ellipsis,textAlign: TextAlign.center,)),
                  ],
                )
              ],
            ),
  ...
  //                 mainAxisAlignment: MainAxisAlignment.center,
  //                 children: [
  //                   Text("Please Wait", style: TextStyle(fontSize: AppAssets.dimen_18, fontFamily: AppAssets.nunitoRegular, color: AppAssets.textDarkGrayColor), maxLines: 2, overflow: TextOverflow.ellipsis,),
  //                 ],
  //               )
  //             ],
  //           ),
